...
## CLEAN-001: Tabela `team_info_common` está completamente vazia
...
## CLEAN-002: Ausência de box score por jogador (estatística por jogador/partida)
...
## CLEAN-003: Valores inconsistentes em `game.season_type` ("All Star" vs "All-Star")
- **Table:** game
- **Severity:** warning
...
## CLEAN-004: Times de exibição/defuntos misturados na tabela `game`
- **Table:** game
- **Severity:** warning
...
## CLEAN-005: `height` e `weight` armazenados como texto (não numérico) com strings vazias
...
## CLEAN-006: Data de nascimento sentinela inválida (1900-01-01)
- **Table:** common_player_info
- **Severity:** warning
...
## CLEAN-007: Valores ausentes em `position` (e altura/peso) em common_player_info
- **Table:** common_player_info
- **Severity:** warning
...
## CLEAN-008: Lacuna de cobertura entre `player` e `common_player_info`
...
## CLEAN-009: Nome de franquia inconsistente ao longo do histórico
- **Table:** game
- **Severity:** info
...
## CLEAN-010: `team_details` sem data de contratação do técnico
- **Table:** team_details
- **Severity:** info
